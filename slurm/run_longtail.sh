...
#SBATCH -t 0-07:00                 # Time limit (3 daydef train_tr)
...
conda activate eopsn
cd /nfs/homedirs/koerner/Git/OPS_dual_decision


export DETECTRON2_DATASETS=/nfs/students/koerner/Datasets/
python train_net.py --config-file configs/ours_longtail.yaml --num-gpus 1 DATALOADER.NUM_WORKERS 10
