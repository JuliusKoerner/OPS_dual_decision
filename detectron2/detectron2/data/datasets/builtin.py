...
_PREDEFINED_SPLITS_COCO_PANOPTIC_WITHOUT_LONGTAIL= {
    ...
    "coco_2017_val_panoptic_without_longtail": (
        "Coco2/annotations/panoptic_val2017",
        "Coco2/annotations/panoptic_val2017.json",
        "Coco2/panoptic_stuff_val2017",
    ),
...
def register_all_coco(root):
    ...
    for (
        ...
        if "longtail" in prefix:
            prefix_instances = prefix[: -len("_panoptic_open20_longtail")]
        elif "origin" in prefix:
            prefix_instances = prefix[: -len("_panoptic_origin")]
        else:    
